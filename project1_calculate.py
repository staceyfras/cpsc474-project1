...
def main():
    ...
    while p1.input[0] != None or p2.input[0] != None or p3.input[0] != None or p4.input[0] != None or p5.input[
        0] != None:
        # internal section
        if p1.input[0] == 'i':
            p1.internal()
        ...
        # recieve section
        # p1 receive
        if p1.input[0] == 'r1' or p1.input[0] == 'r2' or p1.input[0] == 'r3' or p1.input[0] == 'r4' or p1.input[
            0] == 'r5' or p1.input[0] == 'r6' or p1.input[0] == 'r7' or p1.input[0] == 'r8' or p1.input[0] == 'r9':
        ...
        # p2 receive
        if p2.input[0] == 'r1' or p2.input[0] == 'r2' or p2.input[0] == 'r3' or p2.input[0] == 'r4' or p2.input[
            0] == 'r5' or p2.input[0] == 'r6' or p2.input[0] == 'r7' or p2.input[0] == 'r8' or p2.input[0] == 'r9':
        ...
        # p3 receive
        if p3.input[0] == 'r1' or p3.input[0] == 'r2' or p3.input[0] == 'r3' or p3.input[0] == 'r4' or p3.input[
            0] == 'r5' or p3.input[0] == 'r6' or p3.input[0] == 'r7' or p3.input[0] == 'r8' or p3.input[0] == 'r9':
            if p3.input[0] == 'r1' and send[0] != 0:
                ...
                p3.receive(send[8])
        # p4 receive
        if p4.input[0] == 'r1' or p4.input[0] == 'r2' or p4.input[0] == 'r3' or p4.input[0] == 'r4' or p4.input[
            0] == 'r5' or p4.input[0] == 'r6' or p4.input[0] == 'r7' or p4.input[0] == 'r8' or p4.input[0] == 'r9':
            if p4.input[0] == 'r1' and send[0] != 0:
                ...
                p4.receive(send[8])
        # p5 receive
        if p5.input[0] == 'r1' or p5.input[0] == 'r2' or p5.input[0] == 'r3' or p5.input[0] == 'r4' or p5.input[
            0] == 'r5' or p5.input[0] == 'r6' or p5.input[0] == 'r7' or p5.input[0] == 'r8' or p5.input[0] == 'r9':
    ...
    userOutput = input("Enter name for output file with .txt at the end:  ")
    p1.result(userOutput)
    p2.result(userOutput)
    p3.result(userOutput)
    p4.result(userOutput)
